...
using MyBlazorApp.Application.Specifications.ExtendedAttribute;
using MyBlazorApp.Domain.Contracts;
using MyBlazorApp.Domain.Enums;
...
namespace MyBlazorApp.Application.Features.ExtendedAttributes.Queries.Export
{
