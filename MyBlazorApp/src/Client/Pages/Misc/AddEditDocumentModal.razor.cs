...
using MyBlazorApp.Client.Infrastructure.Managers.Misc.Document;
using MyBlazorApp.Client.Infrastructure.Managers.Misc.DocumentType;
using System;
...
namespace MyBlazorApp.Client.Pages.Misc
{
