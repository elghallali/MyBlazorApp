...
using MyBlazorApp.Client.Infrastructure.Managers.Catalog.Brand;
using MyBlazorApp.Client.Infrastructure.Managers.Catalog.Product;
...
namespace MyBlazorApp.Client.Pages.Catalog
{
