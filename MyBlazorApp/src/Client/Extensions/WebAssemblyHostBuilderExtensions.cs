...
using MyBlazorApp.Client.Infrastructure.Authentication;
using MyBlazorApp.Client.Infrastructure.Managers;
using MyBlazorApp.Client.Infrastructure.Managers.ExtendedAttribute;
...
namespace MyBlazorApp.Client.Extensions
{
