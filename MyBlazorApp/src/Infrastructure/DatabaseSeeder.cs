...
using MyBlazorApp.Infrastructure.Helpers;
using MyBlazorApp.Infrastructure.Models.Identity;
using MyBlazorApp.Shared.Constants.Permission;
using MyBlazorApp.Shared.Constants.Role;
using MyBlazorApp.Shared.Constants.User;
using System;
using System.Linq;
    ...
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        private void AddAdministrator()
        {
            Task.Run(async () =>
            {
                ...
                {
                    FirstName = "Yassine",
                    LastName = "EL GHALLALI",
                    Email = "y.elghallali@gmail.com",
                    UserName = "elghallaliSuperUser",
                    EmailConfirmed = true,
        ...
        private void AddBasicUser()
        {
            Task.Run(async () =>
            {
                ...
                var basicUser = new BlazorHeroUser
                {
                    FirstName = "Yassine",
                    LastName = "EL GHALLALI",
                    Email = "yassine.elghaaali1@etu.uae.ac.ma",
                    UserName = "yassineUser",
                    EmailConfirmed = true,
                    PhoneNumberConfirmed = true,
                    CreatedOn = DateTime.Now,
                    IsActive = true
