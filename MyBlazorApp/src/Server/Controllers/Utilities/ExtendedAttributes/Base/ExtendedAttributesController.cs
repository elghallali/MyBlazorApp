...
using MyBlazorApp.Application.Features.ExtendedAttributes.Commands.Delete;
...
using MyBlazorApp.Application.Features.ExtendedAttributes.Queries.GetById;
using MyBlazorApp.Domain.Contracts;
using System;
using System.Threading.Tasks;

namespace MyBlazorApp.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
