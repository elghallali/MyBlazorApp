...
using MyBlazorApp.Application.Features.DocumentTypes.Commands.Delete;
using MyBlazorApp.Application.Features.DocumentTypes.Queries.Export;
...
namespace MyBlazorApp.Server.Controllers.Utilities.Misc
{
